...
Checks include: emergency stop, pause, hard vetoes, market session, asset tradability, decision expiry, data quality, spread, stop required, position sizing caps, shorting disabled, duplicate/conflict flags.
