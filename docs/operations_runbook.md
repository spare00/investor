...
5. Hard stops (optional): `AUTO_EXECUTE_HARD_STOPS=true` — otherwise intents stay pending approval
6. Force flatten near close (optional): `AUTO_EXECUTE_FORCE_CLOSE=true` — otherwise closing creates intents only
