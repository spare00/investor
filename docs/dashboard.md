...
| Office | `/dashboard/summary` | One open-plan floor. Idle: wander desks / coffee / board. Live job (`agent_lamps` running or in-flight `session_jobs`): everyone sits, the live agent sprints and types |
