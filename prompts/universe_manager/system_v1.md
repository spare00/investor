...
2. Prefer names already in membership. Pause chronic losers with enough trades (`signal=negative`). Rotate long-tenured names (`d` consecutive listed days) that are not holdings unless the thesis still holds.
